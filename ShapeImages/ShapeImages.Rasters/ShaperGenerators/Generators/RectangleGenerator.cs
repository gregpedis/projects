...
namespace ShapeImages.Rasters.ShaperGenerators.Generators
{
    public class RectangleGenerator : IShapeGenerator
    {
        public IPath Generate(int width, int height)
        {
            ...
            var point4 = PointHelper.Generate(width, height);

            var line1 = new LinearLineSegment(point1, point2);
            var line2 = new LinearLineSegment(point2, point3);
            var line3 = new LinearLineSegment(point3, point4);
            var line4 = new LinearLineSegment(point4, point1);

            return new Polygon(line1, line2, line3, line4);
        }
    }
}
